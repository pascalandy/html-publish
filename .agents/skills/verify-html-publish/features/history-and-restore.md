...
History lists bounded page-changing commits and restore identifiers. Restore selects a reachable page revision through the guarded publish transaction and appends history.
...
- `restore-appends` adds a commit rather than rewinding archive history.
